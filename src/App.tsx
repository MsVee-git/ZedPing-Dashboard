Warning: truncated output (original token count: 51369)
...
function Contacts({ customer }) {
  ...
  async function createGroup(action = groupCreateAction) {
    ...
    try {
      ...
      else notify("Contact list created");
    } catch (error) {
